...
| 文件路径 | 功能说明 |
|----------|----------|
| simple_main.py | 主服务入口，启动HTTP服务器 |
...
|------|----------|--------|--------|----------|
| 管理员 | ADMIN | 500万 | 5000万 | 全部功能 |
| 企业用户 | ENTERPRISE | 300万 | 3000万 | 全部功能 |
| 开发者 | DEVELOPER | 100万 | 1000万 | 生成、API、高质量数据 |
| 高级用户 | PREMIUM | 50万 | 500万 | 生成、API、高质量数据 |
| 标准用户 | STANDARD | 10万 | 100万 | 生成、API、普通质量 |
| 免费用户 | FREE | 100条 | 1000条 | 基础生成、免费质量 |
...
|----------|-----------|--------|----------|
| 企业版 | enterprise | 80万条 | 中型企业 |
| 旗舰版 | flagship | 300万条 | 大型企业 |
| 自定义 | custom | 自定义 | 特殊需求 |
...
| 套餐ID | 名称 | 价格(分) | 配额 | 有效期 |
|--------|------|----------|------|--------|
| basic_monthly | 基础版月付 | 9,999 | 20万 | 30天 |
| basic_yearly | 基础版年付 | 99,999 | 240万 | 365天 |
| pro_monthly | 专业版月付 | 29,999 | 100万 | 30天 |
| pro_yearly | 专业版年付 | 299,999 | 1200万 | 365天 |
| enterprise_monthly | 企业版月付 | 49,999 | 500万 | 30天 |
| enterprise_yearly | 企业版年付 | 499,999 | 6000万 | 365天 |
